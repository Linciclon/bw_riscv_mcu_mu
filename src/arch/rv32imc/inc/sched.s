...
.macro   PMP_SET
    ...
    /* REGION 1 - During init the offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg0, t1
    lw t1, 4(t0)
    csrw pmpaddr1, t1
    ...
    /* REGION 2 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg0, t1
    lw t1, 4(t0)
    csrw pmpaddr2, t1
    ...
    /* REGION 3 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg0, t1
    lw t1, 4(t0)
    csrw pmpaddr3, t1
    ...
    /* REGION 4 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg1, t1
    lw t1, 4(t0)
    csrw pmpaddr4, t1
    ...
    /* REGION 5 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg1, t1
    lw t1, 4(t0)
    csrw pmpaddr5, t1
    ...
    /* REGION 6 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg1, t1
    lw t1, 4(t0)
    csrw pmpaddr6, t1
    ...
    /* REGION 7 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg1, t1
    lw t1, 4(t0)
    csrw pmpaddr7, t1

    /* REGION 8 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg2, t1
    lw t1, 4(t0)
    csrw pmpaddr8, t1
    ...
    /* REGION 9 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg2, t1
    lw t1, 4(t0)
    csrw pmpaddr9, t1
    ...
    /* REGION 10 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg2, t1
    lw t1, 4(t0)
    csrw pmpaddr10, t1
    ...
    /* REGION 11 - During init the cfg_offset is already calculated*/
    lw t1, 0(t0)
    csrs pmpcfg2, t1
    lw t1, 4(t0)
    csrw pmpaddr11, t1
